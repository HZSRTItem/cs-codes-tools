...
namespace JieXiHtmlCSA
{
    class Program
    {
        static void Main(string[] args)
        {
            if(File.Exists(@"D:\code\bin\ZhiWangJieXi.py"))
            {
                if (args.Length != 0)
                {
            ...
            Console.WriteLine("srt_jiexizhiwang [html file] [/out file]");
        ...
        public static string GetCmdInfo(string tfile, string ofile)
        {
            ...
            p.Start(); // 启动程序
            string in_str = @"python D:\code\bin\ZhiWangJieXi.py" + " " + tfile + " " + ofile;
