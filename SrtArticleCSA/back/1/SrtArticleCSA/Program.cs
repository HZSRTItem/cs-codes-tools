...
namespace SrtArticleCSA
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //    @"D:\GroupMeeting\20221002\Article\1-s2.0-S2212095521000298-main.pdf",
            //    "-i",
        ...
        private static bool Usage()
        {
            Console.WriteLine("srt_article [add] [find] ***\n" +
                "    add: [article title] [link files*] [opt:-i info]\n" +
                "    find: [opt:-n + n] \n");
            return true;
        }
        ...
        private static bool Add(string[] args)
        {
            ...
            {
                string art_title = "";
                List<string> link_files = new List<string>(20);
                string info = ""; // -i
                ...
                for (int i = 1; i < args.Length; i++)
                {
                    ...
                    {
                        link_files.Add(args[i]);
                    }
                }

                OSrtArt.Add(art_title, link_files: link_files.ToArray(), info: info);
            }
    ...
    class StaticInfo
    {
        ...
        /// 信息文件
        /// </summary>
        public static string InfoFileName = @"D:\GroupMeeting\Articles\Info.xml";
